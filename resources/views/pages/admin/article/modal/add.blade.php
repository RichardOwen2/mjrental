<div class="modal fade" id="modal_add_article" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-950px">
        <div class="modal-content">
            ...
            <form class="modal-body pt-10 pb-15 px-lg-17" id="form_add_article">
...
<script>
    $(document).ready(function() {
        $('#form_add_article [name="image"]').on('change', function() {
            const file = event.target.files[0];
            const imagePreviewContainer = $('#form_add_article #image-preview-container');
        ...
        $('#form_add_article').on('submit', function(e) {
            ...
            $('#form_add_article [type="submit"]').attr('disabled', true);
            $('#form_add_article [type="submit"]').html(
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#form_add_article [type="submit"]').attr('disabled', false);
                    $('#form_add_article [type="submit"]').html('Simpan')
                    $('#modal_add_article').modal('hide');

                    $('#form_add_article').trigger('reset');
                    articleTable?.draw();
                },
